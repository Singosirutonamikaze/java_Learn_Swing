...
public class Niveau {
    ...
    public Niveau(int _nombreColonnes, int _nombreLignes, int _nombreMines) {
        this.nombreColonnes = _nombreColonnes;
        this.nombreLignes = _nombreLignes;
        this.nombreMines = _nombreMines;
    }
