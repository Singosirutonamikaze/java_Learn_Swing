...
public class Case {
    ...
    private CaseUiInterface caseUi;
    ...
    public void devoiler() throws CaseMineeException, CaseMarqueeException {
        //decouverte de case
        this.plateau.getPartie().demarer(this);
        if (isMine()) {
    ...
    public int getPosition() {
        return this.plateau.getCases().indexOf(this);
    }
    ...
    public CaseUiInterface getCaseUi() {
        return caseUi;
    }

    public void setCaseUi(CaseUiInterface caseUiInterface) {
        this.caseUi = caseUiInterface;
    }
    
    public List<Case> getNonVoisines(){
        List<Case> voisines =  this.getVoisines();
        List<Case> nonVoisines = new ArrayList<>();
        
        for(Case c : this.getPlateau().getCases()) {
            if(!voisines.contains(c) && !this.equals(c)){
                nonVoisines.add(c);
            }
        }
    ...
    public String toString() {
        return "Case{" + "mine = " + this.mine + ", marquée = " + this.marquee + ", index = " + this.getPosition() + '}';
    }
